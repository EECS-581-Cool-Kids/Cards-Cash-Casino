...
namespace CardsCashCasino.Manager
{
    ...
    /// </summary>
    public enum FiveCardDrawBettingPhase
    {
        PREDRAW,
        POSTDRAW
    }
    ...
    public class FiveCardDrawManager
    {
        ...
        /// </summary>
        private FiveCardDrawBettingPhase _bettingPhase = FiveCardDrawBettingPhase.PREDRAW;
        ...
        /// </summary>
        FiveCardDrawPotManager _potManager = new FiveCardDrawPotManager();

        /// <summary>
        /// Initializing PlayerManager class
        /// </summary>
        FiveCardDrawPlayerManager _players = new FiveCardDrawPlayerManager();
    ...
    public class FiveCardDrawPlayerManager
    {
        /// <summary>
    ...
    public class FiveCardDrawPot
    {
        ...
        /// </summary>
        public FiveCardDrawPot(PotType type)
        {
    ...
    public class FiveCardDrawPotManager5
    {
        ...
        /// </summary>
        public List<FiveCardDrawPot> Pots { get; set; }
